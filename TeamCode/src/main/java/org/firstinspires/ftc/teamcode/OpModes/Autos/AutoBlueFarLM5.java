...
@Disabled
@Autonomous(name = "🔵AutoFarLM5🔵")
public class AutoBlueFarLM5 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.update();
        waitForStart();
        robot.outtake.setShootingVelocity(290);///TODO
        robot.update();
        autoTimer.reset();
        while (opModeIsActive()) {
            switch (state) {
                case 0:
                    ...
                    robot.outtake.turret.setTargetDegrees(-22);//TODO HABAR NU AM TEO DESCURCA TE
                    state++;
                    break;
                case 1:
                ...
                case 3:
                    if(robot.isDone()) {
                        robot.outtake.turret.setTargetDegrees(-72);//TODO TEO HABAR NU AM 😭
                ...
                case 8:
                    if (timer.milliseconds() >= 750 || robot.intake.isFull) {
                        robot.outtake.turret.setTargetDegrees(-67);
