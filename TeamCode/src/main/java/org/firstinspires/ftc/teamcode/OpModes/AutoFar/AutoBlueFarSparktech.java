...
@Disabled
@Autonomous(name = "🔵AutoFarSparkTech🔵")
public class AutoBlueFarSparktech extends LinearOpMode {

    public Robot robot;
    public int state = 0;


    public Pose startPose = new Pose(55, 6, Math.toRadians(180));
    public Pose precollectSpikeMark3Pose = new Pose(55, 35.5, Math.toRadians(180));
    public Pose controlPoint1 = new Pose(60, 38);
    public Pose controlPointLoading1 = new Pose(34, 11);
    public Pose controlPointLoading2 = new Pose(19, 21);
    public Pose collectSpikeMark3Pose = new Pose(12, 35.5, Math.toRadians(180));
    public Pose collectLoadingZone1 = new Pose(13, 12, Math.toRadians(180));
    public Pose preCollectLoadingZone1 = new Pose(23, 12, Math.toRadians(180));

    public Pose collectLoadingZone2 = new Pose(13, 12, Math.toRadians(-165));
    public Pose preCollectLoadingZone2 = new Pose(16, 17, Math.toRadians(-165));

    //    public Pose collectLoadingZone2 = new Pose(127.5, 17, Math.toRadians(-30));
    //    public Pose preCollectLoadingZone2 = new Pose(129, 8, Math.toRadians(-30));

    public Pose loadingArtifact = new Pose(12, 10, Math.toRadians(-90));

    public Pose parkPose = new Pose(11, 10, Math.toRadians(180));
