...
public class AutoBlueFar extends LinearOpMode {
    ...
    public Pose shootPose = new Pose( 58,15.5, Math.toRadians(-65));
    public Pose collectPose = new Pose(12, 23.5, Math.toRadians(95));
    public Pose parkPose = new Pose(40, 17, Math.toRadians(30));
    public Pose controlPoint1 = new Pose(27, 4);
